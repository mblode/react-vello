...
const files = ['rvello.js', 'rvello_bg.wasm', 'rvello.d.ts', 'rvello_bg.wasm.d.ts']

if (!fs.existsSync(srcDir)) {
  console.error('[react-vello] Missing src/wasm assets. Run "pnpm -w wasm:build" and re-sync.')
  process.exit(1)
}
