...
type HostComponent<Props> = ForwardRefExoticComponent<
  WithChildren<Props> & RefAttributes<NodeRef>
>;

function createHostComponent<Type extends HostType, Props>(
  type: Type
): HostComponent<Props> {
  const Component = forwardRef<NodeRef, WithChildren<Props>>(
...
export const LinearGradient = createHostComponent<
  "LinearGradient",
  LinearGradientProps
>("LinearGradient");
export const RadialGradient = createHostComponent<
  "RadialGradient",
  RadialGradientProps
>("RadialGradient");
export const Mask = createHostComponent<"Mask", MaskProps>("Mask");
export const ClipPath = createHostComponent<"ClipPath", ClipPathProps>(
  "ClipPath"
);
