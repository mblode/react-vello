...
const packageWasmDir = path.join(
  repoRoot,
  "packages",
  "react-vello",
  "src",
...
const packageArtifacts = [
  {
    src: path.join(pkgDir, "rvello.js"),
    dest: path.join(packageWasmDir, "rvello.js"),
  },
  {
    src: path.join(pkgDir, "rvello_bg.wasm"),
    dest: path.join(packageWasmDir, "rvello_bg.wasm"),
  },
  {
    src: path.join(pkgDir, "rvello.d.ts"),
    dest: path.join(packageWasmDir, "rvello.d.ts"),
  },
  {
    src: path.join(pkgDir, "rvello_bg.wasm.d.ts"),
    dest: path.join(packageWasmDir, "rvello_bg.wasm.d.ts"),
  },
];
