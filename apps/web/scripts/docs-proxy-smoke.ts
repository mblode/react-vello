...
import { HOST_SITE_NAME, rewriteDocsHtml } from "../lib/docs-proxy.ts";

const UPSTREAM_DOCS_URL = "https://react-vello.blode.md/docs";
const PRODUCT = "React Vello";
...
const OG_SITE_NAME_CASES = [
  ...
  String.raw`[\"$\",\"meta\",null,{\"property\":\"og:site_name\",\"content\":\"React Vello\"}]`,
  String.raw`[\"$\",\"meta\",null,{\"content\":\"React Vello\",\"property\":\"og:site_name\"}]`,
];
